...
//           <Destaque addToCart={() => handleAddToCart({ title: "Donkey Kong Country", price: "223,90"  })} 
...
const App = () => {
  const [cartItems, setCartItems] = React.useState([]);
  const [selectedGenre, setSelectedGenre] = React.useState(''); // State to track the selected genre
  ...
  const handleGenreChange = (event) => {
    setSelectedGenre(event.target.value); // Update the selected genre when the user changes the selection
  };
